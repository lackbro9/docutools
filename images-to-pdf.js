/* DocuTools - Images to PDF tool (JPG + PNG) */
(function(){
  'use strict';
  document.addEventListener('DOMContentLoaded', function(){
    ...
    function handleFiles(fileList){
      var result = window.DocuUtils.validateFiles(fileList, { acceptExt: ['.jpg', '.jpeg', '.png'], acceptMime: ['image/jpeg', 'image/png'], maxSizeMB: 25, maxFiles: 30 });
